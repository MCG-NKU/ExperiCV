...
if __name__=='__main__':
    ...
    data = BSDS500_TEST(transform=transform,dataPath='data/images/test')
    ...
    net.load_state_dict(torch.load('checkpoints/hed_15.pth',map_location='cpu'))

    print(net)

    ########### testing   ###########
    net.eval()
    to_pil_image = transforms.Compose([rescale,transforms.ToPILImage()])
